...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { desc: @component.desc, game_id: @component.game_id } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { desc: @component.desc, game_id: @component.game_id } }
